...
- 🛡️ **错误处理**：自动重试、超时控制、全局错误边界
- 📱 **移动端支持**：响应式设计，手机、平板完美适配 ⭐新增
...
### v2.1.0 (2024-10-17 - 移动端适配)

**移动端支持：**
- 📱 完整的响应式设计(320px - 2560px+)
- 📱 移动端导航栏(标签页切换)
- 📱 触摸优化(最小44px触摸区域)
- 📱 字体自动缩放(防止iOS缩放)
- 📱 横竖屏自适应
...
**文档完善：**
- 📚 新增移动端使用指南([MOBILE_GUIDE.md](./MOBILE_GUIDE.md))
